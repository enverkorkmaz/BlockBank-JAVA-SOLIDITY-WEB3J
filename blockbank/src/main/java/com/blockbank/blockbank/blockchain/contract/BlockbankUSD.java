...
public class BlockbankUSD extends Contract {
    public static final String BINARY = "0x";

    public BlockbankUSD(String contractAddress, Web3j web3j, Credentials transactionManager, ContractGasProvider gasProvider) {
        super(BINARY, contractAddress, web3j, transactionManager, gasProvider);
    }

    public static BlockbankUSD load(String contractAddress, Web3j web3j, Credentials transactionManager, ContractGasProvider gasProvider) {
        return new BlockbankUSD(contractAddress, web3j, transactionManager, gasProvider);
    }
